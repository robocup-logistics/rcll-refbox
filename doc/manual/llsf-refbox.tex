...
\msgspec{AttentionMessage.proto}{Client-Server}{events}{refbox}{controller}%
{%
...
\msgspec{BeaconSignal.proto}{Peer-to-Peer}{1\,sec}{robots \& refbox}{any}%
{%
...
\msgspec{GameInfo.proto}{Client-Server}{start}{refbox}{controller}%
{%
...
\msgspec{MachineInfo.proto}{P2P \& C-S}{$0.25$\,sec}{refbox}{all}%
{%
...
\msgspec{MachineCommands.proto}{Client-Server}{event}{controller}{refbox}%
{%
...
{%
  ...
  broadcasting, two messages are sent, one for each team. In these
  OrderInfo messages the team color will be set and only orders
  matching this color will be included.
...
\msgspec{RobotCommands.proto}{Client-Server}{event}{controllers}{refbox}%
{%
