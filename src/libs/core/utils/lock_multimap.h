...
LockMultiMap<KeyType, ValueType, LessKey>::LockMultiMap() : __mutex(new Mutex())
{
}
...
LockMultiMap<KeyType, ValueType, LessKey>::LockMultiMap(
  const LockMultiMap<KeyType, ValueType, LessKey> &lm)
: std::map<KeyType, ValueType, LessKey>::map(lm), __mutex(new Mutex())
{
}
