 ...
 */
void
NetworkNameResolverThread::resolved_name(char *name, struct sockaddr *addr, socklen_t addrlen)
{
 ...
 */
void
NetworkNameResolverThread::resolved_address(struct sockaddr_in *addr, socklen_t addrlen, char *name)
{
