...
public:
   ...
   */
	...
	virtual void tlog_debug(struct timeval *t, const char *component, fawkes::Exception &e) = 0;
	virtual void tlog_info(struct timeval *t, const char *component, fawkes::Exception &e)  = 0;
	virtual void tlog_warn(struct timeval *t, const char *component, fawkes::Exception &e)  = 0;
	virtual void tlog_error(struct timeval *t, const char *component, fawkes::Exception &e) = 0;
