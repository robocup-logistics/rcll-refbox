...
(defglobal
  ...
  ?*PRODUCTION-POINTS-SS-STORAGE* = -1
  ?*PRODUCTION-POINTS-SS-RELOCATION* = -1
  ?*PRODUCTION-POINTS-SS-PER-STORED-VOLUME* = -1
  ?*PRODUCTION-POINTS-SS-MAX-TOTAL-POINTS* = -20
  ?*PRODUCTION-POINTS-SS-PAYMENT-INTERVAL* = 60
  ?*PRODUCTION-POINTS-SS-STORAGE-GRACE-PERIOD* = 60
  ?*PRODUCTION-POINTS-SS-MAX-NUM-PAYMENTS-PER-VOLUME* = 5
