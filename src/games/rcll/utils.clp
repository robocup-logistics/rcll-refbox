...
(deffunction tag-ids-from-machine-name (?machine-name)
  (if (eq ?machine-name C-CS1) then (return (create$ 102 101)))
  (if (eq ?machine-name C-CS2) then (return (create$ 104 103)))
  (if (eq ?machine-name C-RS1) then (return (create$ 112 111)))
  (if (eq ?machine-name C-RS2) then (return (create$ 114 113)))
  (if (eq ?machine-name C-BS) then (return (create$ 122 121)))
  (if (eq ?machine-name C-DS) then (return (create$ 132 131)))
  (if (eq ?machine-name C-SS) then (return (create$ 142 141)))
  (if (eq ?machine-name M-CS1) then (return (create$ 202 201)))
  (if (eq ?machine-name M-CS2) then (return (create$ 204 203)))
  (if (eq ?machine-name M-RS1) then (return (create$ 212 211)))
  (if (eq ?machine-name M-RS2) then (return (create$ 214 213)))
  (if (eq ?machine-name M-BS) then (return (create$ 222 221)))
  (if (eq ?machine-name M-DS) then (return (create$ 232 231)))
