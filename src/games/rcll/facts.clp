...
(deffacts orders
  ...
  (order (id  2) (complexity C1) (quantity-requested 1) (start-range 0 0)
	       (activation-range 1020 1020) (duration-range 1020 1020))
  ; early orders
  (order (id  3) (complexity C2) (quantity-requested 1) (start-range 680 820)
	       (activation-range 545 885) (duration-range 120 180))
  (order (id  4) (complexity C3) (quantity-requested 1) (start-range 680 820)
	       (activation-range 1020 1020) (duration-range 135 205))
  ; normal orders
  (order (id  5) (complexity C0) (quantity-requested 1) (start-range 225 450))
  (order (id  6) (complexity C0) (quantity-requested 2) (start-range 340 790))
  (order (id  7) (complexity C0) (quantity-requested 1) (start-range 790 1020))
  (order (id  8) (complexity C1) (quantity-requested 1) (start-range 565 790)
	       (activation-range 340 565) (duration-range 100 170))
  ; overtime
